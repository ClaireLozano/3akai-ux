            ...
            <form role="form">
                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <div id="manageaccess-share-code">
                            <h5 class="manageaccess-overview-header">__MSG__ACTIVATE_SHARE_CODE__</h5> 
                            <!-- -->
                        </div>
...
<div id="manageaccess-share-code-template"><!--
    <h4>__MSG__SELECT_ROLE_FOR_SHARE_CODE__</h4>

    <div class="form-group clearfix well">
        <label for="manageaccess-share-code-role" id="label-manageaccess-share-code-role" class="pull-left">__MSG__SHARE_CODE_EXPLANATION__</label>
        <select id="manageaccess-share-code-role" class="pull-right form-control">
            <option value="disable">Disable</option>
            {for role in roles}
                <option value="${role.id}">${role.name}</option>
            {/for}
        </select>
        <input type="text" class="form-control" id="share-code" onClick="this.select();" value="" readonly>
    </div>
--></div>
